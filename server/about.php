...
<body>
   ...
   <section class="about">
      ...
      <div class="row">
         ...
         <div class="image">
            <img src="images/bartender.png" alt="">
         </div>

         <div class="content">
            <h3>Một số thông tin về chúng tôi</h3>
            <p>FL shop là một quán trà sữa thú vị và độc đáo nằm tại trung tâm thành phố. Với sứ mệnh mang đến sự độc đáo và tinh tế trong thế giới trà sữa, chúng tôi tự hào về việc kết hợp những hương vị tinh tế, nguyên liệu tươi ngon và chất lượng phục vụ vượt trội.</p>
